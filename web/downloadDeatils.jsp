                ...
                <div id="templatemo_header">    
                    ...
                    <div id="templatemo_menu" class="ddsmoothmenu">
                        <ul> <li><a href="Administrator.jsp">Home</a></li>
                            ...
                            <li><a href="downloadDeatils.jsp" class="selected">Downloads</a></li>
                    ...
                    <br>
                        <br>
                            ...
                            <div id="templatemo_main">
                                <h2 align="center" style="font-family: 'Arial';font-size: 15pt;color: #66afe9;">Download Details</h2>
                                ...
                                <form name="forms">          
                                    ...
                                    <%
                                        ...
                                        try {
                                            ...
                                            pst = connection.prepareStatement("select * from downloads");
