        ...
        <div id="templatemo_body_wrapper">
            <div id="templatemo_wrapper"><span id="templatemo_wrapper_top"></span>
                <div id="templatemo_header">    
                    ...
                    <div id="templatemo_menu" class="ddsmoothmenu">
                        <ul> <li><a href="Administrator.jsp">Home</a></li>
                            ...
                            <li><a href="AdminReport.jsp" class="selected">Report</a></li>
                ...
                <div id="templatemo_main">
                    ...
                    <h3 style="font-family:'Arial';text-align: center;color: #66afe9;"> Graph Report Of Over All Performance </h3>
                    <form method="POST" action="AdminBarChartTime" class="form-horizontal" >
                    ...
                    <form method="POST" action="AdminBarchart" class="form-horizontal" >
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-md-15">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <form method="POST" action="AdminBarChartUsage" class="form-horizontal" >
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-md-15">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
