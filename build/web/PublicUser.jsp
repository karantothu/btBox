                    ...
                    <br>
                     ...
                     <table class="table table-bordered" id="example">
                        ...
                        <tr align="justfy">
                            ...
                            <th>Public</th>
                                ...
                                while (rs.next()) {
                                    ...
                                    //int total=(size/1024);
                                    user = rs.getString(2);
                                    cloudid = rs.getString(3);
                                    member = rs.getString(4);
                                    dateandtime = rs.getString(8);
                        ...
                        <tr class="success">
                            ...
                            <td align="center"><button type="button" name="Request" class="btn btn-default" value="Request" onclick="request(<%=rs.getInt(1)%>);"/>Request</td>   
